...
This project is part of my coding boot camp homework series. Project purpose was to build a train schedule app.

Feel free to look at my projects. If you want to drop a line visit my personal [website](http://davidsoto.dev/).

## Launch

To see the project live tap [here](https://daviddadev.github.io/train-schedule-app/index.html), and thanks for visiting my GitHub. Enjoy.
